...
%% Track 2
trans.x.T2 = -0.1698; %B2 x
trans.y.T2 = 1.4703; %B2 y
lung.T2 = 1;
angle.T2 = deg2rad(109.8563); %alpha 2

%% Track 3
trans.x.T3 = 0.1564; %B3 x
trans.y.T3 = 1.878; %B3 y
lung.T3 = 1;
angle.T3 = deg2rad(352.8188); %alpha 3

%% Track 4
trans.x.T4 = 1.0146; %B4 x
trans.y.T4 = 2.1603; %B4 y
lung.T4 = 1;
angle.T4 = deg2rad(43.5918); %alpha 4

%% Circle
trans.x.C = 1.5578; %C x
trans.y.C = 2.6774; %C y
