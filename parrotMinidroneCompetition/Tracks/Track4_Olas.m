...
%% Track 2
trans.x.T2 = -0.1215; %B2 x
trans.y.T2 = 1.485; %B2 y
lung.T2 = 1;
angle.T2 = deg2rad(104.0654); %alpha 2

%% Track 3
trans.x.T3 = -0.0592; %B3 x
trans.y.T3 = 2.435; %B3 y
lung.T3 = 1;
angle.T3 = deg2rad(68.4312); %alpha 3

%% Track 4
trans.x.T4 = -0.0453; %B4 x
trans.y.T4 = 3.3702; %B4 y
lung.T4 = 1;
angle.T4 = deg2rad(109.8664); %alpha 4

%% Circle
trans.x.C = -0.3002; %C x
trans.y.C = 4.0756; %C y
