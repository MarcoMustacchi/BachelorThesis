...
%% Track 2
trans.x.T2 = 0.3861; %B2 x
trans.y.T2 = 0.6823; %B2 y
lung.T2 = 1;
angle.T2 = deg2rad(320.5441); %alpha 2

%% Track 3
trans.x.T3 = 0.8053; %B3 x
trans.y.T3 = 0.8634; %B3 y
lung.T3 = 1;
angle.T3 = deg2rad(86.1926); %alpha 3

%% Track 4
trans.x.T4 = 0.5045; %B4 x
trans.y.T4 = 1.7343; %B4 y
lung.T4 = 1;
angle.T4 = deg2rad(131.9204); %alpha 4

%% Circle
trans.x.C = 0.0034; %C x
trans.y.C = 2.2924; %C y
