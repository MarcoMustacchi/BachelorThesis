  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ...
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1083022093U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1274688108U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3995321895U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3310407324U);
    } else {
      return 0;
    }
  } else {
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3321228431U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(101670141U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4088199139U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2177137725U);
  }
  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 4:
      {
        if (strcmp(instanceChksum, "skwA5Cl50ddnLgvmQ92UtNH") == 0) {
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 4:
      {
        if (strcmp(tpChksum, "skwA5Cl50ddnLgvmQ92UtNH") == 0) {
